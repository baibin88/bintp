<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/Users/yinbin/Code/bintp/public/../application/admin/view/cate/edit.htm";i:1506183754;s:75:"/Users/yinbin/Code/bintp/public/../application/admin/view/common/header.htm";i:1498214292;s:73:"/Users/yinbin/Code/bintp/public/../application/admin/view/common/left.htm";i:1503389303;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                            ...
                                            <div class="tab-content tabs-flat">
                                                <div id="home11" class="tab-pane active">
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <!--单行文本-->
                                                            <select name="pid">
                                                                <option value="0">顶级栏 <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                                                ...
                                                                <?php endforeach; endif; else: echo "" ;endif; ?> <option></option>
                                                            </select>
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <!--单行文本-->
                                                            <input class="form-control"  placeholder="" name="cate_name" type="text" value="<?php echo $cates['cate_name']; ?>">
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-1" style="top: 6px;">
                                                            ...
                                                            <input type="hidden" name="img" value="<?php echo $cates['img']; ?>" data-id="<?php echo $cates['id']; ?>" id="imgcat">
                                                        </div>
                                                        <div class="col-sm-1" style="top: 6px;">
                                                            <!--单行文本-->
                                                            <input type="button" value="取消上传" onclick="delload()">

                                                        </div>
                                                    </div>
                                                    <?php if(empty($cates['img'])):?>
                                                     <div class="form-group" id="cateimgdiv" style="display: none;">
                                                     <?php else:?>
                                                         <div class="form-group" id="cateimgdiv" style="display: block;">
                                                    <?php endif;?>
                                                        <label for="username" class="col-sm-2 control-label no-padding-right"></label>
                                                        <div class="col-sm-6" style="top: 6px;">
                                                            <label id="cateimg">
                                                                <img src="__ADMIN__/uploads/cateimg/<?php echo $cates['img']; ?>"  id="catimga " height="100" />
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6" style="top: 6px;">
                                                            ...
                                                            <div class="radio" style="float: left; padding-left:10px ">
                                                                <label>
                                                                    <input name="cate_attr"  value="1" type="radio"
                                                                    <?php if($cates['cate_attr'] == 1): ?> checked="checked" <?php endif; ?>>
                                                                    <span class="text"> 列表页栏目(可以发表文章)</span>
                                                                </label>
                                                            </div>
                                                            <div class="radio" style="float: left; padding-left:10px ">
                                                                <label>
                                                                    <input  name="cate_attr"  value="2" <?php if($cates['cate_attr'] == 2): ?> checked="checked" <?php endif; ?> type="radio" class="inverted" >
                                                                    <span class="text"> 封面频道栏目</span>
                                                                </label>
                                                            </div>
                                                              <div class="radio" style="float: left; padding-left:10px ">
                                                                <label>
                                                                    <input  name="cate_attr"  value="3" <?php if($cates['cate_attr'] == 3): ?> checked="checked" <?php endif; ?> type="radio" class="inverted" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <!--单行文本-->
                                                            <input class="form-control"  placeholder="" name="list_tmp" type="text" value="<?php echo $cates['list_tmp']; ?>">
                                                        </div>
                                                          <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <!--单行文本-->
                                                            <input class="form-control"  placeholder="" name="index_tmp" type="text" value="<?php echo $cates['index_tmp']; ?>">
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <!--单行文本-->
                                                            <input class="form-control"  placeholder="" name="article_tmp" type="text" value="<?php echo $cates['article_tmp']; ?>">
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                      <div class="form-group">
                                                ...
                                                <div id="profile11" class="tab-pane">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <!--单行文本-->
                                                            <input class="form-control"  placeholder="" name="keywords" type="text" value="<?php echo $cates['keywords']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <!--单行文本-->
                                                            <textarea name="desc" class="form-control" id="" ><?php echo $cates['desc']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="widget flat radius-bordered">
                                                            ...
                                                            <div class="widget-body">
                                                                <div class="widget-main no-padding">
                                                                    <textarea name="content" id="content" ><?php echo $cates['content']; ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    var SCOPE = {
        ...
        'cate_delimg' :"<?php echo url('Cate/delimg'); ?>"
      }
